...
const shoppings = JSON.parse(
	fs.readFileSync(path.resolve(__dirname, '../../public/data/nt_shopping_20250529.json'), 'utf-8')
);

const defaultMapData = {
	"type": "FeatureCollection",
	"name": "Shopping_District_NEW_TPE",
	"features": []
}

const convertShopping = () => {
	const filename = "shopping_district_new_tpe";
